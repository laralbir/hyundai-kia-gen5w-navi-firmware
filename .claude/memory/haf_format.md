...
- **Herramienta**: [`tools/map_render_viewer/`](../../tools/map_render_viewer/) genera una galería HTML (guiado WebP + atlas RGB/RGBA + landmarks ASTC) trabajando directo sobre el ZIP — verificado con 500 imágenes embebidas. El HTML de salida no se commitea.
